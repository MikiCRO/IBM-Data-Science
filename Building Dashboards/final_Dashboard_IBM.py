...
def update_input_container(data):
...
def update_output_container(data):
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        ...
        return [
            ...
            html.Div(className='chart-item', children=[value],style={'display': 'flex'})
            ]
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x='Automobile_Sales',
        y='Year'))
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(className='chart-item', children=[values],style={'display': 'flex'})
        ]
        # else:
        #     return None
